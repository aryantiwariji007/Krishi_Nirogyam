...
if app_mode == "Home":
    ...
    st.image(r"C:\Users\ASUS\OneDrive\Desktop\Plant disease detection\Home.jpeg", caption="Healthy Plant", use_column_width=True)  # Replace local path with a public image URL or host your image on GitHub
